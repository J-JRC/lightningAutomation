...
public class BasicElementGateway {
	...
	public static WebElement findElementByPresence(WebDriver driver, By locator, int timeout)
		...
		try {
			...
			throw new FrameworkException("findElementByPresence: " + "[ " + locator + " ]" + " with timeout: " + timeout, e);
		}
		return webElement;
	}
	...
	public static List<WebElement> findElementsByPresence(WebDriver driver, By locator, int timeout)
		...
		try {
			...
			throw new FrameworkException("findElementsByPresence: " + "[ " + locator + " ]" + " with timeout: " + timeout, e);
		}
	...
	public static WebElement findElementByClickable(WebDriver driver, By locator, int timeout)
		...
		try {
			...
			throw new FrameworkException("findElementByClickable: " + "[ " + locator + " ]" + " with timeout: " + timeout, e);
		}
		return webElement;
	}
	...
	public static WebElement findElementByVisible(WebDriver driver, By locator, int timeout)
		...
		try {
			...
			throw new FrameworkException("findElementByVisible: " + "[ " + locator + " ]" + " with timeout: " + timeout, e);
		}
		return webElement;
	...
	public static WebElement findElementByInvisible(WebDriver driver, By locator, int timeout)
		...
		try {
			...
			throw new FrameworkException("findElementByInvisible: " + "[ " + locator + " ]" + " with timeout: " + timeout, e);
		}
		return webElement;
	}
	 ...
	 * @throws FrameworkException 
	 */
	public static void waitForElementNotPresent(WebDriver driver, WebElement element, int timeout) throws FrameworkException {
		try {
	 ...
	 * @throws FrameworkException 
	 */
	public static void waitForElementToClickable(WebDriver driver, WebElement element, int timeout) throws FrameworkException {
		try {
	 ...
	 * @throws FrameworkException 
	 */
	public static void waitForElementToEnable(WebDriver driver, WebElement element, int timeout) throws FrameworkException {
		try {
	 ...
	 * @throws FrameworkException 
	 */
	public static void waitForElementToDisable(WebDriver driver, WebElement element, int timeout) throws FrameworkException {
		try {
	 ...
	 * @throws FrameworkException 
	 */
	public static void waitForElementToDisplay(WebDriver driver, WebElement element, int timeout) throws FrameworkException {		
		try {
	 ...
	 * @throws FrameworkException 
	 */
	public static void waitForElementToDisappear(WebDriver driver, WebElement element, int timeout) throws FrameworkException {		
		try {
