...
public abstract class BasePage {
	...
	public IBaseElement findElement(String locator, Until waitUntil) throws FrameworkException {
		...
		try {
			...
			throw new FrameworkException("find element based on locator and synchronization type failed witn an exception: ", e);
		}
		return baseElement;
	}
	...
	public IBaseElement findElement(String locator, Until waitUntil, int timeout) throws FrameworkException {
		...
		try {
			Method method = BasicElementGateway.class.getDeclaredMethod(waitUntil.getMethodName(),
					new Class[] { WebDriver.class, By.class, int.class });
			baseElement = new BaseElement(driver,
					(WebElement) method.invoke(null, driver, LocatorUtil.determineByType(locator), timeout), 
					locator,
					locator, footprint);
		} catch (Exception e) {
			e.printStackTrace();
	 ...
	 *             throws a UIException
	 */
	public IBaseElement findElement(String locator, LocatorType type, Until waitUntil, int timeout) throws FrameworkException {
		IBaseElement baseElement = null;
		try {
			Method method = BasicElementGateway.class.getDeclaredMethod(waitUntil.getMethodName(),
					new Class[] { WebDriver.class, By.class, int.class });
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<IBaseElement> findElements(String locator, LocatorType type, Until waitUntil) throws FrameworkException {
