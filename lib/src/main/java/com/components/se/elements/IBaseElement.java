...
public interface IBaseElement {
	...
	/**
	 * To click check box. If given value is true it will check. If given value is
	 * false it will uncheck.
	 * 
	 * @param check
	 *            boolean
	 * @throws FrameworkException
	 ...
	 * 
	 * @throws FrameworkException
	 *             Any exception will be wrapped in UIExcepton
	 */
	 ...
	 * unless that attribute is not present, in which case the value of the property
	 * with the same name is returned (for example for the "value" property of a
	 * textarea element). If neither value is set, null is returned. The "style"
	 * attribute is converted as best can be to a text representation with a
	 * trailing semi-colon. The following are deemed to be "boolean" attributes, and
	 * will return either "true" or null:
	 *
	 ...
	 * 
	 * @param isAlignTop
	 *            Is a Boolean value: If true, the top of the element will be
	 *            aligned to the top of the visible area of the scrollable ancestor.
	 *            Corresponds to scrollIntoViewOptions: {block: "start", inline:
	 *            "nearest"}. This is the default value. If false, the bottom of the
	 *            element will be aligned to the bottom of the visible area of the
	 *            scrollable ancestor. Corresponds to scrollIntoViewOptions: {block:
	 *            "end", inline: "nearest"}.
	 * @throws FrameworkException
	 *             throw a UIException
	 */
	...
	/**
	 * Deselect all options that have a value matching the argument. That is, when
	 * given "foo" this would deselect an option like:
	 *
	 * &lt;option value="foo"&gt;Bar&lt;/option&gt;
	 *
	 * @param value
	...
	/**
	 * @return The first selected option in this select tag (or the currently
	 *         selected option in a normal select) as IBaseElement
	 * @throws NoSuchElementException
	 *             If no option is selected
	 */
	...
	/**
	 * @return The all selected options in this select tag (or the currently
	 *         selected option in a normal select) as List of  IBaseElement
	 * @throws NoSuchElementException
	 *             If no option is selected
	 */
