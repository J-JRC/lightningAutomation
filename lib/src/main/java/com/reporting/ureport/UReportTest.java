...
public class UReportTest {
	...
	public String toPayload() {
		return "{ \"uid\" : \"" + uid + "\", \"build\":\"" + buildId + "\", \"name\":\"" + name + "\", \"description\":\""
				+ description + "\", \"start_time\":\"" + startTime + "\", \"end_time\":\"" + endTime + "\","
			+ generateInfo() + ", \"body\":" + generateSteps() + ", \"failure\":" + this.failure + ", \"status\":\""
